...
Remember to answer immediately and directly with your answer in the following format: "ANSWER: $ANSWER" (without quotes) where $ANSWER is the answer to the problem, and you do not need to use a \\boxed command.
""".strip()
...
def math_solver(
    ...
    """
    solver = [prompt_template(USER_PROMPT_TEMPLATE_NO_CoT), generate()]
